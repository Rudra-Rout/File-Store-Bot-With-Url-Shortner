    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://t.me/+0MmB4WG6-1Q4ZDc9")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/MissAngleesupportbot"),
                        InlineKeyboardButton("Instagram", url="https://www.instagram.com/dialogdhamaka")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝗧𝗲𝗮𝗺](https://t.me/MissAngleesupportbot)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=MissAnglee_{str_to_b64(file_er_id)}"
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://t.me/MissAngleesupportbot")
                    ],
                    [
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("Support Team", url="https://t.me/MissAngleesupportbot"),
                        InlineKeyboardButton("Instagram", url="https://www.instagram.com/dialogdhamaka")
                    ]
                ]
            )
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝗧𝗲𝗮𝗺](https://t.me/MissAngleesupportbot).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝗧𝗲𝗮𝗺](https://t.me/MissAngleesupportbot).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
